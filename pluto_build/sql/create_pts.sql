...
CREATE TABLE dof_pts_propmaster AS (
    SELECT 
        ...
        REPLACE(lot_frt, '+', '')::double precision as LFFT,
        REPLACE(lot_dep, '+', '')::double precision as LDFT,
        REPLACE(bld_frt, '+', '')::double precision as BFFT,
        REPLACE(bld_dep, '+', '')::double precision as BDFT,
        bld_ext as EXT,
        lot_irreg as IRREG,
