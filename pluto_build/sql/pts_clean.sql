...
SET BORO = CASE WHEN "BORO" = '\"\"' THEN NULL ELSE "BORO" END,
	...
	LFFT = CASE WHEN REPLACE("LOT_FRT", '+', '') ~ '[0-9]+$' THEN REPLACE("LOT_FRT", '+', '') ELSE NULL END,
	LDFT = CASE WHEN REPLACE("LOT_DEP", '+', '') ~ '[0-9]+$' THEN REPLACE("LOT_DEP", '+', '') ELSE NULL END,
	BFFT = CASE WHEN REPLACE("BLD_FRT", '+', '') ~ '[0-9]+$' THEN REPLACE("BLD_FRT", '+', '') ELSE NULL END,
	BDFT = CASE WHEN REPLACE("BLD_DEP", '+', '') ~ '[0-9]+$' THEN REPLACE("BLD_DEP", '+', '') ELSE NULL END,
